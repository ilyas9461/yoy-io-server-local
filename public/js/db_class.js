...
class pgSqlDBClass {
  ...
  static async controlDbDeviceId() {
    ...
    let res = await this.doQuery(query); //pg den veri res.rows ta array object oarak geldi.
  ...
  //Dizi şeklinde kaydedilecek bilgiler çağrıldığı yerde girilir.
  ...
  static tempHumidityDataLog(data) {
   ...
   // console.log("DB data :", arrData);
    ...
    let query = "INSERT INTO temp_humidity_log (device_id, socket_id, user_name, temperature, humidity, date_time)" +
      "  VALUES ($1, $2, $3, $4, $5, $6)";
  ...
  static tagDataLog(data) {
    ...
    */
    ...
    let query = "INSERT INTO tag_data_log (device_id, socket_id, user_name, tag_id, tag_remain, date_time)" +
      "  VALUES ($1, $2, $3, $4, $5, $6)";
...
//const { pool } = require("./public/js/pg_config");

// async function insertData() {

//   const res = await pool.query(
//       "insert into users(device_id,user_name,user_pass) values ('AAFF31','deneme2','k21')"
//     );
